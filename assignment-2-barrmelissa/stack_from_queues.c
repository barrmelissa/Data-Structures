...
/*	while(queue_isempty(stack->q1) != 1){
	...
	int val = queue_front(stack->q2);

	while(queue_isempty(stack->q2) != 1){
		int temp2 = queue_dequeue(stack->q2);
		queue_enqueue(stack->q1, temp2);
	}
...
*/
	...
	//while(!queue_isempty(stack->q2)){
	//		temp = queue_dequeue(stack->q2);
	//		queue_enqueue(stack->q1, temp);
	//	}
	}
	temp = queue_front(stack->q1);
...
int stack_from_queues_pop(struct stack_from_queues* stack) {
       ...
       /* while(queue_isempty(stack->q1) != 1){
        ...
        int val = queue_dequeue(stack->q2);
